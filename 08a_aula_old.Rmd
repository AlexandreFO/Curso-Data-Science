...
Scatter Plot milhas por galao vs cilindrada 

```{r}
df_carros %>%
  ggplot(aes(x = displ, y = hwy)) +
  geom_point() +
  labs(x="cilindrada",y="milhas por galão")
```
...
df_carros %>%
  ...
  labs(title="Faceamento dos graficos", x="cilindrada",y="milhas por galão")
```
...
Mostra relação entre PIB per capita e expectativa de vida no ano de 1952.
